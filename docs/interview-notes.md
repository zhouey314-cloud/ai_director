...
1. **Why?** To make ai_director an inspectable, reusable portfolio artifact.
2. **Hardest problem?** Timeline conversion and media verification.
...
7. **Failure learned?** Provider and Premiere integration need external verification.
